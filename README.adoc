...
The CI job that performs the releases, named _docs-theme-publisher_, is configured in Jenkins.
It can be found in the Jenkins instance that's managed by the MuleSoft docs team.
