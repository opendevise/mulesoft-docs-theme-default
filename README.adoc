...
By doing so, it insulates the site generator from the details of how this integration works and provides some additional control over the markup used for these areas of the page.
